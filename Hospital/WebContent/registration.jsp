          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form action="Registration" method="post">
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-user" name="idno" placeholder="Address" required="required">
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" name="address" placeholder="ID Number" required="required">
                  </div>
                  <div class="col-sm-6">
